...
int main(int argc, char** argv) {
    ...
    if (argc > 1 && strcmp(argv[1], "-i") == 0) {
        ...
        if (strcmp(argv[1], "-i") == 0) {
            printf(" алькул€тор может выполн€ть такие команды, как сложение, умножение, деление, вычитание и возведение в степень\n");
            printf("¬ведите операцию\n если хотите выйти, напишите exit\n если хотите ввести значение из предыдущего выражени€, введите &\n");
        }
        int ampersant = 0; 
        do {
            int null = 0;
...
//на гитлабе удалены следующие строчки: 196, 199, 200, 221-228, 246-268, 270 (мб еще что-то есть, но вроде все)
