...
int main(int argc, char** argv) {
    ...
    if (argc > 1 && strcmp(argv[1], "-i") == 0) {
        ...
        if (strcmp(argv[1], "-i") == 0) {
            printf("Калькулятор может выполнять такие команды, как сложение, умножение, деление, вычитание и возведение в степень\n");
            printf("Введите операцию\n если хотите выйти, напишите exit\n если хотите ввести значение из предыдущего выражения, введите &\n");
        }
        int ampersant = 0; 
        do {
            int null = 0;
