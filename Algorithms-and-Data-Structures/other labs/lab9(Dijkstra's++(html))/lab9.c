...
int main(int argc, char** argv) {
    ...
    if (argc > 1 && strcmp(argv[1], "-t") == 0) {
        ...
        printf("¬ведите число вершин в графе:\n");
        if (scanf("%d", &vertices_in_the_graph) != 1) {
            
            return -1;
        }
        printf("¬ведите начало и конец пути:\n");
        if (scanf("%d%d", &start, &end) != 2) {
            
            return -1;
        }
        printf("¬ведите число ребер в графе:\n");
        ...
        printf("¬ведите данные графа(начало, конец и длинны ребер):\n");
